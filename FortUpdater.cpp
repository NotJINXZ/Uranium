...
bool FortUpdater::Init(uintptr_t UObjectArray, uintptr_t GetNameByIndex, uintptr_t FnFree)
{
	if (!UObjectArray || !GetNameByIndex || !FnFree) return false;
...
char* FortUpdater::fGetObjectName(uintptr_t Object)
{
	...
	return this->fGetNameByIndex(index);
}
